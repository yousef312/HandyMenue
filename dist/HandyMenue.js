    ...
    if(typeof define === 'function' && define.amd) {
        ...
        options : {
            ...
            class ContextMenuClose{
                constructor(self,details,event,closer,fd =0){
                    this.self = self;
            ...
            elements.forEach(item=>{
                ...
                if(item.type=='line'){
                    ...
                    back = $('<div></tdivd>').css('width',((parseFloat(menuWidth)-parseFloat(indent))+'px')).css('zIndex','5');
                    back_ = $('<div></div>').css('width','10%');
                    center = $('<span></span>').attr('class','text-container');
                    ...
                    switch(item_type){
                            ...
                            if(group_name){
                                ...
                                buttonsSetUp[1].forEach(itom=>{ i++;
                                    if(itom[0]==group_name){
                                        found = true;
                                        buttonsSetUp[1][i][1].push([box,item.func]);
                                ...
                                if(!found){
                                    ...
                                    front.append(ball);
                                    buttonsSetUp[1].push([group_name,[[box,item.func,state,item.label]],ball,buttonsIndex]);
                                }
                                addressez[1]++;
                        ...
                        case 'check-box':
                            ...
                            front.append(state);
                            buttonsSetUp[2].push([item.name,box,state,[src,labels],item.func,item.func_off,buttonsIndex]);
                            addressez[2]++;
                        ...
                        case 'data-set':
                            ...
                            a(inp,inpsty);
                            box.append(inp);
                            buttonsSetUp[3].push([box,inp,item.func,item.allowed,[front,back],buttonsIndex]);
                            addressez[3]++;
                        ...
                        case 'definition':
                            ...
                            item.moreDef ? buttonsSetUp[5].push([box,definitionBox,[item.moreDef,item.label,options],buttonsIndex]) : buttonsSetUp[5].push([box,definitionBox,undefined,buttonsIndex]);
                            addressez[5]++;
                        ...
                        case 'slider':
                            ...
                            buttonsSetUp[6].push([box,end,init,step,limit,item.func,format,bocko,bockostate,buttonsIndex]);
                            addressez[6]++;
                        ...
                        case 'art-show':
                            ...
                            buttonsSetUp[7].push([box,artShow,artShowRes]);
                            addressez[7]++;
            ...
            this.launchContextMenu = function(e){
                self.onopen.forEach(item=>item(new ContextMenuOpen(self,e.target,details,buttons,self.disable,'launch',0,e)));
                lastSpot = e.target;
                details['x'] = e.clientX;
                details['y'] = e.clientY;
                ...
                wall = $('<div id="handymenuwall"></div>'); a(wall,wallCss);
                $('body').append(wall);
                wall.mousedown((e)=>{self.disableMenu(e,'forced')});
                wall.contextmenu((e)=>{e.preventDefault();});
                ...
                if(self.container == null){
                    ...
                    if((availWidth-parseFloat(x)) < menuWidth && (availHeight-parseFloat(y)) > self.menuHeight){
                        self.onedge.forEach(item=>item(new ContextMenuEdge('right',(availWidth-parseFloat(x)),menuWidth,(availHeight-parseFloat(y)),self.menuHeight,self,x,y,availWidth-(parseFloat(menuWidth)+1),null,e,details)));
                        ...
                        self.onedge.forEach(item=>item(new ContextMenuEdge('bottom',(availWidth-parseFloat(x)),menuWidth,(availHeight-parseFloat(y)),self.menuHeight,self,x,y,null,availHeight-(parseFloat(self.menuHeight)+1),e,details)));
                        menu.css('bottom','1px').css('top','unset').css('left',x).css('right','unset');
                    }else if((availHeight-parseFloat(y)) < self.menuHeight && (availWidth-parseFloat(x)) < menuWidth){
                        self.onedge.forEach(item=>item(new ContextMenuEdge('right-bottom',(availWidth-parseFloat(x)),menuWidth,(availHeight-parseFloat(y)),self.menuHeight,self,x,y,availWidth-(parseFloat(menuWidth)+1),availHeight-(parseFloat(self.menuHeight)+1),e,details)));
                    ...
                    if(!self.used){
                        self.onappend.forEach(item=>item(new ContextMenuAppend(details,self.container,e,e.target,self,self.disable)));
            ...
            this.appendFunctions = function(){
                ...
                buttonsSetUp[0].forEach(item=>{
                    ...
                    item[0].click((e)=>{
                        ...
                        else if(item[1]) item[1](new ButtonClick(e.clientX,e.clientY,self,item[0][0],'normal button',item[2],null,details));
                ...
                buttonsSetUp[1].forEach(itm=>{
                    //buttonsSetUp[2].push([group_name,[[item_id,item.func,state,item.label]],ball,index]);
                    if(!itm['disabled'])
                    itm[1].forEach(item=>{
                        item[0].click(function(e){
                            ...
                            else item[1](new ButtonClick(e.clientX,e.clientY,self,item[0][0],'radio-button',item[3],details,details));
                            registerData(item[0],item.label);
                            self.disableMenu(e,'normal');
                        });
                    });
                ...
                //sliders
                if(buttonsSetUp[6].length>0){i=0;
                    buttonsSetUp[6].forEach(item=>{
                        //buttonsSetUp[4].push([item_id-0,end-1,init-2,step-3,limit-4,item.func-5,format-6,bocko-7,bockostate-8,index]);
                        i++;
                ...
                buttonsSetUp[3].forEach(item=>{
                    ...
                    if(!item["disabled"]){
                        item[0].mouseenter(function(){
                            ...
                            item[1][0].focus();
                        }).mouseleave(blurInput).click(blurInput);
                        item[0].contextmenu((e)=>{e.preventDefault();});
                ...
                buttonsSetUp[5].forEach(item=>{
                    //buttonsSetUp[5].push([item_id,definitionBox,[item.moreDef,item.label,options]])
                    if(!item['disabled']){
                        item[0].mouseenter(()=>{
                        ...
                        if(item[2]!=undefined){
                            ...
                            function expandDefinition(e){
                                ...
                                if(typeof item[2][2]==='boolean' &&item[2][2]==true){
                                    ...
                                    mozUserSelect:'none',webkitUserSelect:'none',cursor:'default',marginBottom:'4px'},styleTag.sheet);
                                    stel('.btn-defs-HandyMenue:hover',{backgroundColor:'rgb(250,250,250)',transition:'all .5s'},styleTag.sheet);
            ...
            this.final={};
            this.disableMenu= function(e){
                details['x'] = e.clientX;
                details['y'] = e.clientY;
                self.onclose.forEach(item=>item(new ContextMenuClose(self,details,e,e.currentTarget)));
                if(wall!=null){ wall.remove(); wall = null;}
                ...
                if(self.ondetach.length>0){
                    self.ondetach.forEach(item=>item(new ContextMenuDetach(details,self.container,e,e.target,self)));
                    self.used = false;
