...
(function(root,HandyMenue,MainMenue){
    ...
    if(typeof define === 'function' && define.amd) {
        ...
        options : {
            ...
            var wall = $('<div id="handymenuwall"></div>'); 
                    ...
                    switch(item_type){
                        ...
                        case 'definition':
                            ...
                            if(item.moreDef){
                                ...
                                .css('left','20px').css('top','50px').css('padding',"10px").append($('<b></b>').text(item.label))
                                .append($('<p></p>').text(item.moreDef));
                                    ...
                                    for (const x in item.options)
                                        if (item.options.hasOwnProperty(x)){
                                            if(['copy','search','readOL','exit'].indexOf(x)!=-1) {
                                                btn=$('<div></div>').attr('class','btn-defs-HandyMenue').text(x);
                                                moreDef.append(btn);
                                                btns[x]=btn;
                    ...
                    if(!item['disabled']){
                        ...
                        if(item[2]!=undefined){
                            ...
                            function expandDefinition(e){
                                ...
                                if(item[2][1]!=undefined)
                                    for (const x in item[2][1])
                                        if (item[2][1].hasOwnProperty(x)) 
                                            switch (x) {
                                                case 'copy':item[2][1][x].click(async function(e){
                                                        try{
                                                    ...
                                                    break;
                                                case 'exit':item[2][1][x].click(closeDefs);
                                                    break;
                                                case 'search':item[2][1][x].click(function(){
                                                ...
                                                case 'readOL':item[2][1][x].click(function(){
                                ...
                                else item[2][0].dblclick(closeDefs);
